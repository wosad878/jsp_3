...
<body>
			...
			<div class="container-fluid">
				<div class="row">
					<ul class="pagination">
						...
						%>
						<li><a
							href="./<%=board%>List.do?curPage=<%=pager.getStartNum() - 1%>"><span
						...
						%>
						<li><a
							href="./<%=board%>List.do?curPage=<%=pager.getLastNum() + 1%>"><span
								class="glyphicon glyphicon-chevron-right"></span></a></li>
						<%
							}
						%>
						<li><a
							href="./<%=board%>List.jsp?curPage=<%=pager.getTotalPage()%>"><span
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-1">
				<a href="./<%=board%>WriteForm.do" id="btn" class="btn btn-primary">Write</a>
			</div>
		</div>
	</div>
